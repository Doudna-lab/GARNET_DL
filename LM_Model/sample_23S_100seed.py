...
out_fasta = 'out/23S_from_Superset_triples_finetune_0_18_6_300_rot_flash_update_seed100.t0.2.fasta'
start = 'FILE:Ecoli_23S_7K00.fasta'
start_string = 100
num_samples = 100 # number of samples to draw
batch_size = 50 # Make num_samples % batch_size = 0
max_new_tokens = 2840 # number of tokens generated in each sample
