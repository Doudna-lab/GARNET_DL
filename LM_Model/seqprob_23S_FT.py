...
print(time.ctime())
# -----------------------------------------------------------------------------
in_ckpt = '/global/scratch/users/jcate/23S_Hyperthermophiles_triples_finetune_0_18_6_300_rot_flash' #23S_triples_0_18_6_300' # Input checkpoint file name, i.e. 23S_97tokens.pt, minus the suffix, with directory.
...
model.eval()
log_probs = model.sequence_probability_masked(x, mask)
