...
print(time.ctime())
# -----------------------------------------------------------------------------
in_ckpt = '/global/scratch/users/jcate/Superset_triples_finetune_0_18_6_300_rot_flash_update' # prefix of .pt file.
...
out_fasta = 'out/16S_from_Superset_triples_finetune_0_18_6_300_rot_flash_update_seed100.t0.2.fasta'
start = 'FILE:Ecoli_16S_rRNA.fasta'
start_string = 100
num_samples = 100 # number of samples to draw
batch_size = 50 # Make num_samples % batch_size = 0
max_new_tokens = 1440 # number of tokens generated in each sample
