...
print(time.ctime())
# -----------------------------------------------------------------------------
#in_ckpt = '/global/scratch/users/jcate/Superset_triples_resume_0_18_6_300_rot_flash_update' # prefix of .pt file.
in_ckpt = '/global/scratch/users/jcate/23S_Hyperthermophiles_triples_finetune_0_18_6_300_rot_flash' # prefix of .pt file.
...
out_fasta = 'out/23S_from_23S_Hyperthermophiles_triples_finetune_0_18_6_300_rot_flash.t0.6.fasta'
start = 'FILE:Ecoli_23S_7K00.fasta'
start_string = 384
