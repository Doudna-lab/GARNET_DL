...
print(time.ctime())
# -----------------------------------------------------------------------------
in_ckpt = '/global/scratch/users/jcate/Superset_triples_resume_0_18_6_300_rot_flash' #23S_triples_0_18_6_300' # Input checkpoint file name, i.e. 23S_97tokens.pt, minus the suffix, with directory.
