...
def plot_results(filenames, model_names, output_filename):
    ...
    for i, (filename, model_name) in enumerate(zip(filenames, model_names)):
        ...
        plt.plot(steps[3:-2], smoothed_perplexities[1:], label=model_name, linewidth=3.5, color=color)
    ...
    plt.title('Nucleotide Token Effects', fontsize = 26)
    plt.grid(False)
...
filenames = ['train_23S_pairs_0_18_6_300_rot2_flash.log', 'train_23S_pairs_0_18_6_300_rot_flash.log',
             'train_23S_triples_0_18_6_300_rot2_flash.log', 'train_23S_triples_0_18_6_300_rot_flash.log']  
model_names = ['paired-nt tokens, overall RoPE', 'paired-nt tokens, individual layer RoPE', 'triple-nt tokens, overall RoPE',
               'triple-nt tokens, individual layer RoPE'] #, 'quadruple-nt tokens']
output_filename = 'RNA_tokens_perplexity_23S_rot_rot2.pdf'
